...
#ifndef __BK_GRAPH_H__
#define __BK_GRAPH_H__
...
public:
	...
	Graph(size_t node_num_max, size_t edge_num_max, void (*err_function)(const char *) = NULL);

	// Destructor
	~Graph();

	// Only allow move construction / assignment
