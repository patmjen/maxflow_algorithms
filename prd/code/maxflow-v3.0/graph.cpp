	  ...
	  error_function(err_function)
{
	...
	nodes = (node*) mmalloc(node_num_max*sizeof(node));
	arcs = (arc*) mmalloc(2*edge_num_max*sizeof(arc));
	...
	void Graph<captype,tcaptype,flowtype>::reallocate_nodes(int num)
{
	...
	nodes = (node*) mrealloc(nodes_old, node_num_max*sizeof(node));
	...
	void Graph<captype,tcaptype,flowtype>::reallocate_arcs()
{
	...
	arcs = (arc*) mrealloc(arcs_old, arc_num_max*sizeof(arc));
